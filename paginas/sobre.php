                    ...
                    <div class="row g-5">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 350px;">
                            <div class="position-relative h-100">
                                <img class="img-fluid position-absolute w-100 h-100" src="sobre.jpg" alt="" style="object-fit: cover;">
                            </div>
                        </div>
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="row gy-2 gx-4 mb-4">
                                <div class="col-sm-6">
                                    <p class="mb-0 text-white"><i class="fa fa-arrow-right text-primary me-2"></i>Conforto</p>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-0 text-white"><i class="fa fa-arrow-right text-primary me-2"></i>Pontualidade</p>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-0 text-white"><i class="fa fa-arrow-right text-primary me-2"></i>Confiança</p>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-0 text-white"><i class="fa fa-arrow-right text-primary me-2"></i>Modernidade</p>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-0 text-white"><i class="fa fa-arrow-right text-primary me-2"></i>Compromisso</p>
                                </div>
                                <div class="col-sm-6">
                                    <p class="mb-0 text-white"><i class="fa fa-arrow-right text-primary me-2"></i>Serviço 24/7</p>
                                </div>
                            </div>
                        </div>
                    </div>
